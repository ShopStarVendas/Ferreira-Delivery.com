  ...
  produtosNoCarrinho.forEach((produto, index) => {
    ...
    productDiv.innerHTML = `
      <div class="product-details">
        ...
        <a href="https://api.whatsapp.com/send?phone=+5519971439458&text=Ops... ${produto.nome} nao foi adicionado no carrinho!" class="contact-button">Fale Conosco no WhatsApp</a>
